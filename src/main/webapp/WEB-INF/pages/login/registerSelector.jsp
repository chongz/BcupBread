...
<body>
<div class="mui-content login-content" ng-controller="registerSelector">
    ...
    <div class="mui-row bread-row" style="margin-top: 6%;" ng-click="phoneReg();">
