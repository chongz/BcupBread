...
<body >
<!-- mui-content -->
<div class="mui-content login-content" ng-controller="retrievePhonePassword">
    ...
    <div class="row" style="margin-top: 7%;" >
        <div class="login-bubble">
            <p>如果忘记了密码，我们可以给你发送手机短信重置密码。</p>
            <div class="input-box">
                <input type="text" class="input-text" placeholder="手机号" ng-model="phoneNo"/>
                <a><span ng-click="sendSMS();" ng-show="sendSMSFlag == 0">发送验证码</span></a>
            </div>
            <div class="input-box">
                <input type="text" ng-model="validcode" placeholder="验证码" />
                <a><span ng-show="sendSMSFlag == 1" ng-click="resendSMS();">{{resendText}}</span></a>
            </div>
            <input type="password" ng-model="password" placeholder="新密码"/>
        </div>
    </div>


    <div class="mui-row bread-row" style="margin-top: 7%" ng-click="forgotPassword();">
        <a class="cup-btn cup-btn-white-loginreg">
            <span>重置密码</span>
        </a>
    </div>
